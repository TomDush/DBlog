...
/**
 * Change la collection présente dans les objects ticket pour que seuls les derniers commentaires soient chargés.<br/>
 *
 * TODO faire que ces chargements soient lazyfifés. TODO intercepter les execption hibernate.
 *
